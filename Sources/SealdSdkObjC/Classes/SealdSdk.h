 ...
 *
 * @param groupId  The Id of the group for which to create a TMR access.
 ...
 * @param isAdmin Should this TMR access give the group admin status.
 ...
 *
 * @param groupId The Id of the group for which to list TMR accesses.
...
/**
 * Search group TMR temporary key that can be used with the TMR JWT.
 *
 ...
 *
 * @param groupId The Id of the group concerned by the TMR access.
 * @param temporaryKeyId Id of the TMR access to convert
 * @param tmrJWT TMR JWT to use
 * @param overEncryptionKey The raw encryption key to use. This *MUST* be a cryptographically random buffer of 64 bytes.
 * @param deleteOnConvert Should the access be deleted after conversion.
 * @param error A pointer to a SealdError* where details will be stored in case of error.
 */
 ...
 *
 * @param groupId The Id of the group concerned by the TMR access.
 * @param temporaryKeyId Id of the TMR access to delete.
 * @param error A pointer to a SealdError* where details will be stored in case of error.
 */
