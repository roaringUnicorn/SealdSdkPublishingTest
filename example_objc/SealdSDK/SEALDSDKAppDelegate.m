...
BOOL testSealdSDK(void)
{
    @try {
        ...
        SealdGroupTmrTemporaryKey* gTMRKey =  [sdk1 createGroupTMRTemporaryKeyWithGroupId:groupTMRId authFactor:tmrAuthFactor isAdmin:NO overEncryptionKey:overEncryptionKey error:&error];
        NSCAssert(error == nil, error.localizedDescription);
